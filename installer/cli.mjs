#!/usr/bin/env node
// next-supabase-agent-harness installer.
//   npx --yes github:<owner>/next-supabase-agent-harness#<tag> <command> [flags]
...
const USAGE = `next-supabase-agent-harness
...
Usage:
  ...
  doctor   [--dir .]
  enable   <module>   (${'gate-styleguide, gate-gated-routes, mutation, ci-provenance, ci-dast, ci-lighthouse'})
  disable  <module>

Placeholders: PROJECT_NAME PROJECT_SLUG GITHUB_OWNER SECURITY_OWNERS DEFAULT_BRANCH`
