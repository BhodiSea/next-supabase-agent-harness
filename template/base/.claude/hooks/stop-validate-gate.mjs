...
// STOP_HOOK_STEPS: Array<[name, command]>), so projects extend the gate — e.g. add an
// RLS-isolation suite or a unit run — without editing this hook (which is itself a
// harness-protected file). Resolved relative to this hook: ../../ is the project root.
